...
//        val stop_btn : Button = findViewById(R.id.pause_btn)
        ...
        play_btn.setOnClickListener(){
            if (isPlaying){
                mediaPlayer.pause()
                isPlaying = false
                play_btn.setBackgroundResource(R.drawable.playbutton)
            }
            else{
                mediaPlayer.start()
                isPlaying = true
                play_btn.setBackgroundResource(R.drawable.pausebutton)
        ...
        title_txt.text = ""+ resources.getResourceEntryName(R.raw.forever_star)
